...
class ClubController extends Controller
{
    ...
    // Validacion
        $validacion=[
            ...
            'mail'=>'required|email',
            'telefonos'=>'required|numeric|regex:/^[\d]{9}?$/',
            'logo'=>'mimes:jpg,jpeg,bmp,png',
        ];

        $mensaje=[
            'required'=>'El :attribute es obligatorio',
            'email'=>'El :attribute no es un email',
            'regex'=>'El teléfono debe ser un número de 9 cifras',
    ...
    public function buscar(Request $request){
        ...
        ->Where('mail','LIKE','%'.$mail.'%')->paginate(50);
    ...
    // public function borrarImagen($filepath,$fileName)
    // {
