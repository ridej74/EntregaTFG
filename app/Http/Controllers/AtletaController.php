...
class AtletaController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $mensaje=[
            ...
            'min'=> 'El :attribute debe contener al menos 3 caracteres',
            'max'=> 'El :attribute es demasiado largo (máximo 100 caracteres)',
        ]; 
    ...
    public function buscar(Request $request){
        ...
        ->Where('apellido_2','LIKE','%'.$apellido_2.'%')->paginate(50);
