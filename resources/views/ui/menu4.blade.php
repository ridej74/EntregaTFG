            ...
            <div class="flex justify-between items-center">
                ...
                <div class="md:flex items-center" :class="isOpen ? 'block' : 'hidden'">
                    <div class="flex flex-col mt-2 md:flex-row md:mt-0 md:mx-1 ">
                        <a class="my-2 text-center text-2xl text-gray-700 mb-2 leading-5 hover:text-blue-600 hover:underline md:mx-4 md:my-0" href="../atletas_clubes">Atletas</a>
                        <a class="my-2 text-center text-2xl text-gray-700 mb-2 leading-5 hover:text-blue-600 hover:underline md:mx-4 md:my-0" href="../clubes">Clubes</a>
                        <a class="my-2 text-center text-2xl text-gray-700 mb-2 leading-5 hover:text-blue-600 hover:underline md:mx-4 md:my-0" href="../carreras_clasificaciones">Carreras</a>
                        <a class="my-2 text-center text-2xl text-gray-700 mb-2 leading-5 hover:text-blue-600 hover:underline md:mx-4 md:my-0" href="../noticias">Noticias</a>
                        @if (Auth::check())
                            <a class="my-2 text-center text-2xl text-gray-700 leading-5 hover:text-blue-600 hover:underline md:mx-4 md:my-0" href="../administracion">Administración</a>
                        @endif
                    </div>
                <div class="flex flex-col mt-2 md:flex-row md:mt-0 md:mx-1">
                    <div class="flex flex-col md:flex-row md:ml-5 md:items-center py-2 md:mx-0 items-center">                          
                        ...
                        <div x-data="{ open: false }">
                            ...
                            <button class="px-3 py-2 mx-auto text-2xl text-center font-semibold rounded border border-blue-800 bg-transparent hover:border-transparent md:text-2xl  text-blue-800 leading-5 hover:text-blue-900 hover:bg-blue-50 md:mx-0  select-none no-outline focus:shadow-outline" @click="open = true">Buscar Atletas </button>
                ...
                <div class="flex flex-col md:flex-row md:ml-5 md:items-center py-2 md:mx-0">
                    <a class="block px-3 py-2 mx-auto rounded border border-blue-800 bg-transparent hover:border-transparent text-center text-2xl font-medium text-blue-900 leading-5 hover:text-blue-900 hover:bg-blue-50 md:mx-0 " href="{{route('Atletas.create')}}">
                        Crear Atleta
                    </a>
                </div>
