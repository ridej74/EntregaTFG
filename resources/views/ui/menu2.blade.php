<!-- Menú de navegación del show de carreras con botón para ver clasificaciones atletas por carreras -->
<style>
        ...
        <div class="flex flex-col md:flex-row md:justify-between md:items-center">
            <div class="flex justify-between items-center">
                ...
                <div class="flex flex-col md:flex-row md:ml-5 md:items-center py-2 md:mx-0">
                    <a class="block px-3 py-2 mx-auto rounded border border-blue-800 bg-transparent hover:border-transparent text-center text-2xl font-medium text-blue-900 leading-5 hover:text-blue-900 hover:bg-blue-50 md:mx-0 " href="{{route('tiempos_clasificaciones',$carrera->id)}}">
