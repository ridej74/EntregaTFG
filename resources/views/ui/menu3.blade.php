            ...
            <div class="flex justify-between items-center">
                ...
                <div class="flex flex-col mt-2 md:flex-row md:mt-0 md:mx-1">
                    <div class="flex flex-col md:flex-row md:ml-5 md:items-center py-2 md:mx-0 items-center">                          
                                        <a class="block px-3 py-2 mx-auto rounded border border-blue-800 bg-transparent hover:border-transparent text-center text-2xl font-medium text-blue-900 leading-5 hover:text-blue-900 hover:bg-blue-50 md:mx-0 " href="{{route('carreras_mapa')}}">
                        Mapa de Carreras
                    </a>
                </div>
                <div class="flex"> 
