    ...
    @if($modo == 'Editar')
        <img src="{{asset('storage/uploads/uploads-club/'.$club->id.'.jpg')}}" width="200" class="mt-5 mb-5 bg-green hover:underline"/>  
    @endif  
    ...
    <button type="submit" class="mt-10 p-3 bg-blue-500 w-full hover:bg-indigo-600 text-white font-bold focus:outline focus:shadow-outline uppercase">{{$modo}} Club</button>
</div>