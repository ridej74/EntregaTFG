  ...
  <div class="w-full text-gray-700 bg-white dark-mode:text-gray-200 dark-mode:bg-gray-800">
    <div x-data="{ open: false }" class="flex flex-col max-w-screen-xl px-4 mx-auto md:items-center md:justify-between md:flex-row md:px-6 lg:px-8">
      <div class="p-4 flex flex-row items-center justify-between">
        ...
        <button class="md:hidden rounded-lg focus:outline-none focus:shadow-outline" @click="open = !open">
          <span :class="{'flex': !open, 'hidden': open}">@guest
            ...
            @endif
        @else
            <span class="text-gray-800 text-sm pr-4"><b>Usuario: </b>{{ Auth::user()->name }}</span>    

                <a class="no-underline hover:underline text-blue-800 font-bold text-sm pd-3" href="{{ route('logout') }}"
    ...
    <section class="container mx-auto px-6 p-10">
      ...
      <div class="flex items-center flex-wrap mb-20">
        ...
        <div class="w-full md:w-1/2">
            <a href="{{ route('noticias') }}">
            <img class="gg-image-white inline rounded-full"  alt="Logo" src="{{asset('storage/uploads/imagenes/landing_page/noticias.png')}}"/>
        </div>
      </div>
      <div class="flex items-center flex-wrap mb-20">
        <div class="w-full md:w-1/2">
          <a href="{{ route('administracion') }}">
            <img class="hidden md:block gg-image-white rounded-full py-3 px-6" width="600"  alt="Logo" src="{{asset('storage/uploads/imagenes/landing_page/administracion.png')}}"/> 
          </a>
        </div>
    
        <div class="w-full md:w-1/2 md:pl-10 ">
          <a href="{{ route('administracion') }}">
            <h4 class="text-3xl text-gray-800 font-bold mb-3">Administración</h4>
            <p class="text-gray-600 mb-8">Gestiona los datos de la aplicación.</p>
          </a>
        </div>

        <div class="w-full md:w-1/2">
          <a href="{{ route('administracion') }}">
            <img class="block md:hidden gg-image-white rounded-full py-3 px-6" width="600"  alt="Logo" src="{{asset('storage/uploads/imagenes/landing_page/administracion.png')}}"/> 
          </a>
        </div>
      </div>
    </section>
      ...
      <div class="container mx-auto px-6 pt-10 pb-6">
        <div class="flex flex-wrap">
          <div class="w-full md:w-1/4 text-center text-white  md:text-left">
            ...
            <ul class="mb-4">
              <li class="mt-2">
                <a href="{{ route('faq') }}" class="hover:underline text-white hover:text-orange-500">FAQ</a>
              </li>
              <li class="mt-2">
                <a href="#" class="hover:underline text-white hover:text-orange-500">Ayuda</a>
              </li>
              <li class="mt-2">
                <a href="{{ route('support') }}" class="hover:underline text-white hover:text-orange-500">Support</a>
              </li>
            </ul>
          </div>
          <div class="w-full md:w-1/4 text-center text-white md:text-left">
            <h5 class="uppercase mb-6 font-bold">Reglamento</h5>
            <ul class="mb-4">
              <li class="mt-2">
                <a href="{{ route('reglamento') }}" class="hover:underline text-white hover:text-orange-500">Reglamentación</a>
              </li>
              <li class="mt-2">
                <a href="{{ route('normativa') }}" class="hover:underline text-white hover:text-orange-500">Normativa</a>
              </li>
            </ul>
          </div>
          <div class="w-full md:w-1/4 text-center text-white md:text-left">
            ...
            <ul class="mb-4">
              <li class="mt-2">
                <a href="https://www.facebook.com/triatlonsp" class="hover:underline text-white hover:text-orange-500">Facebook</a>
              </li>
              <li class="mt-2">
                <a href="https://www.instagram.com/p/Buvmol2H6Bd/" class="hover:underline text-white hover:text-orange-500">Instagram</a>
              </li>
              <li class="mt-2">
                <a href="https://twitter.com/intent/tweet?original_referer=http%3A%2F%2Ftriatlonaragon.org&ref_src=twsrc%5Etfw&text=Triatlón%20Aragón%20%3A%20Contacto&tw_p=tweetbutton&url=http%3A%2F%2Ftriatlonaragon.org%2FContenido%2FContacto&via=ivanloire" class="hover:underline text-white hover:text-orange-500">Twitter</a>
              </li>
            </ul>
          </div>
          <div class="w-full md:w-1/4 text-center text-white md:text-left">
            <h5 class="uppercase mb-6 font-bold">Federación</h5>
            <ul class="mb-4">
              <li class="mt-2">
                <a href="{{ route('blog') }}" class="hover:underline text-white hover:text-orange-500">Blog Oficial</a>
              </li>
              <li class="mt-2">
                <a href="{{ route('sobrenosotros') }}" class="hover:underline text-white hover:text-orange-500">Sobre Nosotros</a>
              </li>
              <li class="mt-2">
                <a href="{{ route('contacto') }}" class="hover:underline text-white hover:text-orange-500">Contacto</a>
              </li>
            </ul>
          </div>
        </div>
