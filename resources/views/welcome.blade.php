      ...
      <div class="flex items-center flex-wrap mb-20">
        ...
        <div class="w-full md:w-1/2 md:pl-10 ">
          <a href="{{route('clubes')}}">
            ...
            <p class="text-gray-600">Conoce todos los clubes y sus atletas inscritos en nuestras competiciones</p>
          </a>
        </div>

        <div class="w-full md:w-1/2">
          <a href="{{route('clubes')}}">
            <img class="block md:hidden gg-image-white rounded-full px-6" width="600"  alt="Logo" src="{{asset('storage/uploads/imagenes/landing_page/clubes.png')}}"/> 
          </a>
        </div>
      </div>
