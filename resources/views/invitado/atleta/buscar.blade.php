...
<div class="flex justify-between items-center mb-5 ">
    <form action={{route('invitado.atletas.buscar')}} method="POST">
        @csrf
        <div class="grid grid-cols-1 items-center">   
            <input id="nombre" type="text" class="inline mt-5 p-3 mb-3 bg-white rounded md:mr-1 form-input  @error('nombre') is-invalid @enderror" name="nombre" value="{{isset($atleta->nombre)? ($atleta->nombre): old('nombre')}}" placeholder="Nombre" autocomplete="nombre" autofocus>
            @error('nombre')
            ...
            <input id="apellido_2" type="text" class="inline mb-6 p-3 bg-white rounded md:mr-2 form-input  @error('apellido_2') is-invalid @enderror" name="apellido_2" value="{{isset($atleta->apellido_2)? ($atleta->apellido_2): old('nombre')}}" placeholder="Segundo apellido" autocomplete="apellido_2" autofocus>
            @error('apellido_2')
