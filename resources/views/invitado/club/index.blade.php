                                                ...
                                                <tr>
                                                    ...
                                                    <td class="flex flex-row px-6 py-4 justify-center">
                                                        ...
                                                        <form action="{{route('clubes_vista',$club->id)}}">
                                                            <button type="submit" class="mr-1 bg-transparent hover:bg-yellow-200 text-center text-yellow-500 font-semibold hover:text-yellow-900 py-1 px-2 border border-yellow-900 hover:border-transparent rounded">
                                                                +Info
                                                            </button>
                                                        </form>
                                                        </div>
