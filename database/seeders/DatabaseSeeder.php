...
class DatabaseSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        for($j=1; $j<101;++$j){
            $origen = 'storage/app/public/uploads/imagenes/noticias/' .$j. '.jpg';
            $destino = 'storage/app/public/uploads/uploads-noticias/'.$j.'.jpg';
            $resultado1 = copy($origen, $destino);
        }

        for($i=1; $i<51;++$i){
            $origen1 = 'storage/app/public/uploads/imagenes/clubes/' .$i. '.jpg';
            $destino1 = 'storage/app/public/uploads/uploads-club/'.$i.'.jpg';
            $resultado1 = copy($origen1, $destino1);
        }
