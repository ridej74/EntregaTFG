...
//Parte estática de la aplicación
Route::view('reglamento','/estatica/reglamento')->name('reglamento');
Route::view('normativa','/estatica/normativa')->name('normativa');
Route::view('contacto','/estatica/contacto')->name('contacto');
Route::view('sobrenosotros','/estatica/sobrenosotros')->name('sobrenosotros');
Route::view('blog','/estatica/blog')->name('blog');
Route::view('faq','/estatica/faq')->name('faq');
Route::view('support','/estatica/support')->name('support');